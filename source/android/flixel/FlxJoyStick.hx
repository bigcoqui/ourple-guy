...
class FlxJoyStick extends FlxSpriteGroup
{
	...
	{
		base = new FlxSprite(0, 0).loadGraphic(FlxGraphic.fromFrame(FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/android/joystick.png'), Assets.getText('assets/android/joystick.xml')).getByName('base')));
	...
	{
		thumb = new FlxSprite(0, 0).loadGraphic(FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/android/joystick.png'), Assets.getText('assets/android/joystick.xml')).getByName('thumb')));
