...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	private function createButton(X:Float, Y:Float, Width:Int, Height:Int, Graphic:String, ?Color:Int = 0xFFFFFF):FlxButton
	{
		...
		button.frames = FlxTileFrames.fromFrame(FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/android/virtualpad.png'), Assets.getText('assets/android/virtualpad.xml')).getByName(Graphic), FlxPoint.get(Width, Height));
